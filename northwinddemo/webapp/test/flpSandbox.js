		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "NorthwindDemo",
									"targetURL": "#northwinddemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"northwinddemo-display": {
								"semanticObject": "northwinddemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=northwinddemo",
									"url": sap.ui.require.toUrl("northwinddemo")
								}
							}
						}
					}
